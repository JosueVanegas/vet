...
const LocalController = () => {
  ...
  return (
    <div className="flex items-center justify-around  gap-10 bg-white border  relative ">
      ...
      />
      <select
        className="appearance-none w-20 text-primary outline-none bg-transparent cursor-pointer pl-10 pr-2 py-1 rounded hover:border-secondary transition-colors duration-200"
        name="local"
        defaultValue="es"
